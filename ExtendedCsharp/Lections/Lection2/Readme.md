...
На скриншоте видно, что инвариантный интерфейс не позволяет использовать себя с интерфейсом наследника или с интерфейсом потомка. Параметр T интерфейса может быть как входящим (параметр метода), так и возвращаемым.